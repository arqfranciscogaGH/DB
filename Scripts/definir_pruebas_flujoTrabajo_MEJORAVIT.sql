...
VALUES (@IdFlujoTrabajo, 1, N'MEJORAVIT', N'Mejoravit', N' Mejoravit', NULL, NULL, NULL, NULL, 1, 1)
...
INSERT  INTO  FlujoTrabajoActividad SELECT  @IdFlujoTrabajo,'RAM','Enviar Aviso Retención a cliente Mejoravit','Enviar Aviso Retención a cliente Mejoravit','','','',getdate(),1,1
...
UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_P_R'  WHERE   Clave  ='PM_R'
UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_P_D'  WHERE   Clave  ='PM_D'
UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_P_C'  WHERE   Clave  ='PM_C'
UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_PE_R'  WHERE   Clave  ='PEM_R'
UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_IE_R'  WHERE   Clave  ='IEM_R'
UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_LS_R'  WHERE   Clave  ='LSM_R'

UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_MC_R'  WHERE   Clave  ='MCM_R'
--- UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_A_R'  WHERE   Clave  ='RAM_R'
UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_RA_R'  WHERE   Clave  ='M_RA'

--- UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_A_E'  WHERE   Clave  ='EAM_R'
UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_EA_R'  WHERE   Clave  ='M_A_E'

UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_A_EE'  WHERE   Clave  ='EEAM_R'
UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_A_MC'  WHERE   Clave  ='EAMCM_R'

UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_FF_R'  WHERE   Clave  ='FFM_R'

UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_A_R'  WHERE   Clave  ='AM_R'
UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_F_R'  WHERE   Clave  ='FM_R'
---------------------------------------------------
UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_RA_R'  WHERE   IdEstatus=103

UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_EA_R'  WHERE   IdEstatus=104

UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_EEA_R'  WHERE   IdEstatus=105

UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_EAMC_R'  WHERE   IdEstatus=106

UPDATE  FlujoTrabajoEstatus  SET  Clave  ='M_A_R'  WHERE   IdEstatus=108
--------------------------------------------------------------------
UPDATE  FlujoTrabajoActividad SET  Clave  ='M_P'  WHERE   Clave  ='PM'
UPDATE  FlujoTrabajoActividad SET  Clave  ='M_PE'  WHERE   Clave  ='PEM'
UPDATE  FlujoTrabajoActividad SET  Clave  ='M_IE'  WHERE   Clave  ='IEM'
UPDATE  FlujoTrabajoActividad SET  Clave  ='M_LS'  WHERE   Clave  ='LSM'
UPDATE  FlujoTrabajoActividad SET  Clave  ='M_MC'  WHERE   Clave  ='MCM'

UPDATE  FlujoTrabajoActividad SET  Clave  ='M_RA'  WHERE   Clave  ='RAM'
UPDATE  FlujoTrabajoActividad SET  Clave  ='M_EA'  WHERE   Clave  ='EAM'

UPDATE  FlujoTrabajoActividad SET  Clave  ='M_EEA'  WHERE   Clave  ='EEAM'
UPDATE  FlujoTrabajoActividad SET  Clave  ='M_EAMC'  WHERE   Clave  ='EAMCM'

UPDATE  FlujoTrabajoActividad SET  Clave  ='M_FF'  WHERE   Clave  ='FFM'
UPDATE  FlujoTrabajoActividad SET  Clave  ='M_A'  WHERE   Clave  ='AM'
UPDATE  FlujoTrabajoActividad SET  Clave  ='M_F'  WHERE   Clave  ='FM'
UPDATE  FlujoTrabajoActividad SET  Clave  ='M_FIN'  WHERE   Clave  ='FINM'

UPDATE  FlujoTrabajoActividad SET  Clave  ='M_'  WHERE   Clave  =''



SELECT  * FROM FlujoTrabajoActividad  WHERE IdFlujoTrabajo=20

SELECT  * FROM FlujoTrabajoEstatus WHERE IdFlujoTrabajo=20
